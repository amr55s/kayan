      ...
      {items.map((item) => <article className={styles.cardContent} key={item.id}>
        ...
        <div className={styles.reviewGrid}>
          <form className={styles.form} action={reviewProductCategoryProposalAction}>
            ...
            <Button.Root className={styles.button} type="submit">دمج واعتماد المرادف</Button.Root>
          </form>
          <form className={styles.form} action={reviewProductCategoryProposalAction}>
            <input type="hidden" name="proposalId" value={item.id} />
            ...
            <Button.Root className={styles.button} type="submit">إنشاء قسم واعتماده</Button.Root>
          </form>
          <form className={styles.form} action={reviewProductCategoryProposalAction}>
            <input type="hidden" name="proposalId" value={item.id} />
            ...
            <Button.Root className={`${styles.button} ${styles.danger}`} type="submit">رفض الاقتراح</Button.Root>
          </form>
        </div>
      </article>)}
    </div>}
