    ...
    <div className="space-y-3">
      <div className="rounded-2xl bg-zinc-950 p-4 text-white">
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="rounded-xl border border-white/20 bg-white/10 px-3 py-2 font-mono text-sm font-black" dir="ltr">
            {coupon.code}
          </span>
        </div>
      </div>
      <p className="text-sm font-semibold leading-7 text-zinc-700">{coupon.description}</p>
  ...
  return (
    <>
      ...
      <Modal
        ...
        placement="center"
        classNames={{ base: 'max-w-lg border border-zinc-200 bg-white' }}
      >
        <ModalContent>
          {(onClose) => selected && (
            <>
              ...
              <ModalFooter className="grid grid-cols-[auto_minmax(0,1fr)] gap-2 border-t border-zinc-100">
                <Button
                  isIconOnly
                  variant="flat"
                  onPress={copyCode}
                ...
                <Button
                  ...
                  className="min-h-12 bg-emerald-600 px-4 font-black text-white hover:bg-emerald-700"
                >
