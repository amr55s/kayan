-- Recovered filename matches Staging's applied migration history (20260824182722).
-- The embedded release version remains the original contract, 20260824160000.
