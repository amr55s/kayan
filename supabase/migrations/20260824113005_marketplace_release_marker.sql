-- Correct the release probe to check the real granular-admin table.
begin;
...
values (
  ...
  pg_catalog.jsonb_build_object(
    'version', '20260824113005',
    'name', 'correct_marketplace_release_probe',
...
begin
  ...
  if v_version is distinct from '20260824113005' then return false; end if;
