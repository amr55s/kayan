...
values (
  ...
  pg_catalog.jsonb_build_object(
    'version', '20260830115034',
    'name', 'real_estate_release_marker',
...
begin
  ...
  if v_version is distinct from '20260830115034' then return false; end if;
  if pg_catalog.to_regclass('public.place_real_estate') is null
