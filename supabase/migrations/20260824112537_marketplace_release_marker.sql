-- Release marker after adding the service-role-only Vault provisioning path.
begin;
...
values (
  ...
  pg_catalog.jsonb_build_object(
    'version', '20260824112537',
    'name', 'configure_marketplace_worker_vault',
    'capabilities', pg_catalog.jsonb_build_array(
      ...
      'service_role_worker_vault_configuration'
    )
  ),
  null,
  pg_catalog.now()
...
begin
  ...
  if v_version is distinct from '20260824112537' then return false; end if;
